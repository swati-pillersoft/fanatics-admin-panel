$(document).ready(function () {
  ...
  if ($("#c3-line-chart").length > 0) {
    var c3LineChart = c3.generate({
      bindto: "#c3-line-chart",
      data: {
        columns: [
          ["Player", 40, 16, 10, 40, 17, 20],
          ["Coach/organizer", 50, 20, 10, 40, 15, 25],
          ["Pitch owner", 28, 20, 10, 40, 15, 25],
        ],
        types: {
          Player: "area",
          "Coach/organizer": "line",
          "Pitch owner": "line",
        },
      },
      color: {
        pattern: ["#163972", "#fcce11", "#c84347"],
      },
    });
  }

  if ($("#c3-line-chart-sales").length > 0) {
    var c3LineChart = c3.generate({
      bindto: "#c3-line-chart-sales",
      data: {
        columns: [
          ["Player", 40, 16, 10, 40, 17, 20],
          ["Coach/organizer", 50, 20, 10, 40, 15, 25],
